...
namespace ICSharpCode.SharpZipLib.Core
{
	...
	public class ExtendedPathFilter : PathFilter
	{
		...
		public DateTime MinDate {
			...
			set {
				if (value > maxDate_) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "Exceeds MaxDate");
				}
		...
		public DateTime MaxDate {
			...
			set {
				if (minDate_ > value) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "Exceeds MinDate");
				}
