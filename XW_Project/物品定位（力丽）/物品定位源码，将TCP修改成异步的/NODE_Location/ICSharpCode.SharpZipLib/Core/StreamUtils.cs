	...
	public sealed class StreamUtils
	{
		...
		static public void ReadFully(Stream stream, byte[] buffer, int offset, int count)
		{
			...
			if ((offset < 0) || (offset > buffer.Length)) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(offset));
			}

			if ((count < 0) || (offset + count > buffer.Length)) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(count));
			}
		...
		{
			if (source == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(source));
			}

			if (destination == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(destination));
			}
			...
			if (buffer.Length < 128) {
				throw new ArgumentException("Buffer is too small", SerialportSample.XWUtils.nameof(buffer));
			}
			...
			object sender, string name, long fixedTarget)
		{
			...
			if (progressHandler == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(progressHandler));
			}
