...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class RawTaggedData : ITaggedData
	{
		...
		{
			if (data == null) {
                throw new ArgumentNullException(SerialportSample.XWUtils.nameof(data));
			}
	...
	sealed public class ZipExtraData : IDisposable
	{
		...
		{
			if (taggedData == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(taggedData));
			}
		...
		public void AddEntry(int headerID, byte[] fieldData)
		{
			if ((headerID > ushort.MaxValue) || (headerID < 0)) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(headerID));
			}

			int addLength = (fieldData == null) ? 0 : fieldData.Length;

			if (addLength > ushort.MaxValue) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(fieldData), "exceeds maximum length");
			}
