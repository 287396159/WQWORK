	...
	public class ZipEntry
	{
			...
			CompressionMethod method)
		{
			...
			if (name.Length > 0xffff) {
				throw new ArgumentException("Name is too long", SerialportSample.XWUtils.nameof(name));
			}

			if ((versionRequiredToExtract != 0) && (versionRequiredToExtract < 10)) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(versionRequiredToExtract));
			}
		...
		public long Crc {
			...
			set {
				if (((ulong)crc & 0xffffffff00000000L) != 0) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value));
				}
				this.crc = (uint)value;
			...
			set {
				if (value == null) {
					...
					if (value.Length > 0xffff) {
						throw new System.ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value));
					}
		...
		public string Comment {
			...
			set {
				...
				if ((value != null) && (value.Length > 0xffff)) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "cannot exceed 65535");
				}
