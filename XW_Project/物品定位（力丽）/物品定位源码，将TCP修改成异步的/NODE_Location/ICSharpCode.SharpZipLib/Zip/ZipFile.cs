...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		{
			if (name == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(name));
			}
		...
		{
			if (file == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(file));
			}

			if (!file.CanSeek) {
				throw new ArgumentException("Stream is not seekable", SerialportSample.XWUtils.nameof(file));
			}
		...
		public ZipFile(Stream stream)
		{
			...
			if (!stream.CanSeek) {
				throw new ArgumentException("Stream is not seekable", SerialportSample.XWUtils.nameof(stream));
			}
		...
		{
			if (fileName == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(fileName));
			}
		...
		{
			if (outStream == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(outStream));
			}

			if (!outStream.CanWrite) {
				throw new ArgumentException("Stream is not writeable", SerialportSample.XWUtils.nameof(outStream));
			}

			if (!outStream.CanSeek) {
				throw new ArgumentException("Stream is not seekable", SerialportSample.XWUtils.nameof(outStream));
			}
		...
		{
			if (entry == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(entry));
			}
		...
		public int BufferSize {
			...
			set {
				if (value < 1024) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "cannot be below 1024");
				}
		...
		public void BeginUpdate(IArchiveStorage archiveStorage, IDynamicDataSource dataSource)
		{
			if (archiveStorage == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(archiveStorage));
			}

			if (dataSource == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(dataSource));
			}
		...
		public void Add(string fileName, CompressionMethod compressionMethod, bool useUnicodeText)
		{
			...
			if (!ZipEntry.IsCompressionMethodSupported(compressionMethod)) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(compressionMethod));
			}
		...
		public void Add(string fileName, string entryName)
		{
			...
			if (entryName == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(entryName));
			}
		...
		public void AddDirectory(string directoryName)
		{
			if (directoryName == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(directoryName));
			}
