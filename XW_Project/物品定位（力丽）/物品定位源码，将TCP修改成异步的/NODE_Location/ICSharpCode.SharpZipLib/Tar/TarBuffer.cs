...
namespace ICSharpCode.SharpZipLib.Tar
{
	...
	public class TarBuffer
	{
		...
		*/
		...
		{
			if (inputStream == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(inputStream));
			}
        ...
        /*public string SerialportSample.XWUtils.nameof(Object obj) 
        {
		...
		{
			if (block == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(block));
			}
