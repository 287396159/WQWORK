...
namespace ICSharpCode.SharpZipLib.Tar
{
	...
	public class TarHeader
	{
		...
		public string Name {
			...
			set {
				if (value == null) {
					throw new ArgumentNullException(SerialportSample.XWUtils.nameof(value));
				}
				name = value;
			}
		}
		...
		public long Size {
			...
			set {
				if (value < 0) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "Cannot be less than zero");
				}
				size = value;
			}
		}
		...
		public DateTime ModTime {
			...
			set {
				if (value < dateTime1970) {
					throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(value), "ModTime cannot be before Jan 1st 1970");
				}
		...
		{
			if (header == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(header));
			}
		...
		{
			if (outBuffer == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(outBuffer));
			}
		...
		static public StringBuilder ParseName(byte[] header, int offset, int length)
		{
			...
			if (offset < 0) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(offset), "Cannot be less than zero");
			}

			if (length < 0) {
				throw new ArgumentOutOfRangeException(SerialportSample.XWUtils.nameof(length), "Cannot be less than zero");
			}

			if (offset + length > header.Length) {
				throw new ArgumentException("Exceeds header size", SerialportSample.XWUtils.nameof(length));
			}
		...
		public static int GetNameBytes(StringBuilder name, int nameOffset, byte[] buffer, int bufferOffset, int length)
		{
			...
			if (buffer == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(buffer));
			}
		...
		{
			if (toAdd == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(toAdd));
			}
