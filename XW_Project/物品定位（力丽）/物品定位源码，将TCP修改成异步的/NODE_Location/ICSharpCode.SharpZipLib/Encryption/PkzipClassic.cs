...
namespace ICSharpCode.SharpZipLib.Encryption
{
	...
	public abstract class PkzipClassic : SymmetricAlgorithm
	{
		...
		{
			if (seed == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(seed));
			}

			if (seed.Length == 0) {
				throw new ArgumentException("Length is zero", SerialportSample.XWUtils.nameof(seed));
			}
	...
	class PkzipClassicCryptoBase
	{
		...
		{
			if (keyData == null) {
				throw new ArgumentNullException(SerialportSample.XWUtils.nameof(keyData));
			}
