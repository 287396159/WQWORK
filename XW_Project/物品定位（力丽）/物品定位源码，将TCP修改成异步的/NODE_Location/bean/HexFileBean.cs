...
namespace CiXinLocation.bean
{
    public class HexFileBean
    {
        ...
        /// 主要的设备类型，参考点，节点
        /// </summary>
        public DrivaceTypeAll mainDrivaceType
        {
            get {
                if (mainTypeByte == 0x04) return DrivaceTypeAll.USB_DANGLE;
                if (mainTypeByte == 0x03) return DrivaceTypeAll.CARD;
                else if (mainTypeByte == 0x02) return DrivaceTypeAll.CANKAODIAN;
                else if (mainTypeByte == 0x01) return DrivaceTypeAll.NODE;
                else return DrivaceTypeAll.NOTHING;
            }
        }
        ...
        public ListViewItem getlvItem() {
            ...
            if (mainDrivaceType == DrivaceTypeAll.CARD) lvItem.SubItems.Add("0%");
            return lvItem;
        }
