...
namespace PrecisePositionLibrary
{
    ...
    public class PrecisePosition
    {
        ...
        public static System.Net.Sockets.UdpClient client = null;
        ...
        private static void ListenLocalPort()
        {
            ...
            while (null != client)
            {
                ...
                while (BufferLen >= 13)
                {
                     ...
                     * 
                     * */
                    if(Buffer[Index+1]==TPPID.TagType && Buffer[Index+TPPID.TagPackLen-1]==TPPID.End)
                    {//Tag数据包
                        cs = 0;
