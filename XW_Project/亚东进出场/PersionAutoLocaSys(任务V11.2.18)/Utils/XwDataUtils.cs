...
namespace SerialportSample
{
    class XwDataUtils
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DateTime currentZeroTime()
        {
            DateTime dayBefore = DateTime.Now;
            DateTime zeroTime = new DateTime(dayBefore.Year, dayBefore.Month, dayBefore.Day);
            return zeroTime;
        }
        ...
        /// <returns></returns>
        public static DateTime beforeTimeToSe(double value)
        {
            DateTime dayBefore = DateTime.Now.AddDays(-value);
