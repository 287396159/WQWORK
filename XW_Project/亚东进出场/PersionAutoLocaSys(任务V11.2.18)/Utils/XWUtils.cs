...
namespace SerialportSample
{
    class XWUtils{
        ...
        /// </summary>
        /// <returns></returns>
        public static byte[] longToFourByte(long value)
        {
            byte[] valBt = new byte[4];
            valBt[0] = (byte)((value >> 24) % 0x100);
            valBt[1] = (byte)((value >> 16) % 0x100);
            valBt[2] = (byte)((value >> 8) % 0x100);
            valBt[3] = (byte)(value % 0x100);
            return valBt;
        }

        public static byte[] getUTF8byte(String value) 
        {
           return Encoding.UTF8.GetBytes(value);//crBean.Name
        }

        public static String getUTF8Str(byte[] value) 
        {
