...
class SetType2 : public CDialog
{
	DECLARE_DYNAMIC(SetType2)

public:
	SetType2(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~SetType2();

// 对话框数据
	enum { IDD = IDD_SET_TWO };
...
public:
	...
	afx_msg void OnBnClickedButtonLocalSetname();
	...
	CButton m_button_tag_getpower;
	CButton m_button_tag_setpower;
	CButton m_button_tag_getresponse;
	CButton m_button_tag_setresponse;
	CEdit m_edit_tag_getpower;
	CComboBox m_combo_tag_setpower;
	DWORD m_edit_tag_setresponse;
	CEdit m_edit_tag_getresponse;
	afx_msg void OnBnClickedButtonTagGetresponse();
	afx_msg void OnBnClickedButtonTagSetresponse();
	afx_msg void OnBnClickedButtonTagGetpower();
	afx_msg void OnBnClickedButtonTagSetpower();
};
