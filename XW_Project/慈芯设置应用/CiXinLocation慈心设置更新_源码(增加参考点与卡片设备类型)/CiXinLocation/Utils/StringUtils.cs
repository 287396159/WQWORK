...
namespace CiXinLocation.Utils
{
    class StringUtils {
        ...
        public static String tagHexTypeHandle = "第";
        public static String tagHexTypeWei = "行地址与当前选择的设备类型一致。\r\n不添加该Hex文件";
        ...
        public static String quZhiFanWeiHandle = "取值范围：1~100";
        ...
        public static String appVersion = "检测到USB设备低于当前应用版本，请更新设备";
        public static String appVersionD = "检测到USB设备高于当前应用版本。建议使用最新版本的应用";

        private static void chInEn() {
            appVersion = "The USB device is detected below the current application version. Please update the device";
            appVersionD = "The USB device is detected higher than the current application version. It is recommended to use the latest version of the application";

            tagHexTypeHandle = "the ";
            tagHexTypeWei = " row address is in line with the type of device currently selected.\r\nDo not add this Hex file";
            prompt = "Prompt";
            findCom = "Detected that ";
            Com_Remove = " was pulled out";
            quZhiFanWei = "Range of values: 1~255";
            quZhiFanWei2 = "Range of values: 0.01~2.55";
            quZhiFanWeiHandle = "Range of values: 1~100";
        ...
        public static void getCEnglishHashTable() {
            ...
            ceTable.Add("当前设置设备:", "setting device:");
            ...
            ceTable.Add("设置静止时间", "Set static time");
            ceTable.Add("读取静止时间", "read static time");
            ceTable.Add("设置gsenso", "Set GSENSO");
            ceTable.Add("读取gsenso", "read GSENSO");
            ...
            ceTable.Add("参考点设置", "port Seting");

            ceTable.Add("查询网络连接状态", "query network");
            ceTable.Add("指定wifi信号强度", "WiFi ress");
            ceTable.Add("设置wifi模式", "set wifi mode");
            ceTable.Add("设置wifi静态IP", "set wifi IP");
            ceTable.Add("读取wifi模式", "read wifi mode");
            ceTable.Add("读取wifi静态IP", "read wifi IP");
            ...
            ceTable.Add("取值范围:1~100", "Range of values: 1~100");
