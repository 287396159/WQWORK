...
IMPLEMENT_DYNAMIC(CSetPort, CDialog)
...
BEGIN_MESSAGE_MAP(CSetPort, CDialog)
	...
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BUTTON_REFRESH, &CSetPort::OnBnClickedButtonRefresh)
	ON_BN_CLICKED(IDC_BUTTON_ADD, &CSetPort::OnBnClickedButtonAdd)
	ON_NOTIFY(NM_CLICK, IDC_LIST2, &CSetPort::OnNMClickList2)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_LIST2, &CSetPort::OnNMCustomdrawList2)
	ON_NOTIFY(LVN_COLUMNCLICK, IDC_LIST2, &CSetPort::OnLvnColumnclickList2)
	ON_BN_CLICKED(IDC_BUTTON_DEL, &CSetPort::OnBnClickedButtonDel)
	ON_BN_CLICKED(IDC_BUTTON_SAVE, &CSetPort::OnBnClickedButtonSave)
	ON_BN_CLICKED(IDC_BUTTON_UPDATEToList, &CSetPort::OnBnClickedButtonUpdatetolist)
END_MESSAGE_MAP()
...
void CSetPort::SetListShowHwnd(HWND hwnd)
{
	m_hwnd_ListShow = hwnd;
}
void CSetPort::SetImageShowHwnd(HWND hwnd)
{
	m_hwnd_ImageShow = hwnd;
}

void CSetPort::GetModulePath(LPTSTR path, LPCTSTR module)
{
	TCHAR* s;
	HANDLE Handle = NULL;
	if(module)
...
void CSetPort::InitLoadPortInfo()
{
...
void CSetPort::OnSize(UINT nType, int cx, int cy)
{
...
void CSetPort::OnBnClickedButtonRefresh()
{
	// TODO: Add your control notification handler code here
	InitLoadPortInfo();
}

void CSetPort::OnBnClickedButtonAdd()
{
	// TODO: Add your control notification handler code here
	POSITION ps;
	int nIndex;
...
void CSetPort::OnNMClickList2(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: Add your control notification handler code here
	if(pResult)
		*pResult = 0;
...
void CSetPort::OnNMCustomdrawList2(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CSetPort::OnLvnColumnclickList2(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CSetPort::OnBnClickedButtonDel()
{
	// TODO: Add your control notification handler code here
	POSITION ps;
	int nIndex;
...
void CSetPort::OnBnClickedButtonSave()
{
	// TODO: Add your control notification handler code here
	WCHAR szPath[MAX_PATH] = {0};
	GetModulePath(szPath, NULL);
	...
	{			
		...
		::PostMessage(m_hwnd_ListShow, WM_SETPORT_SAVE_LISTSHOW, 0, 0);
		::PostMessage(m_hwnd_ImageShow, WM_SETPORT_SAVE_IMAGESHOW, 0, 0);
		return ;
	}
	else
	{
...
void CSetPort::OnBnClickedButtonUpdatetolist()
{
	// TODO: Add your control notification handler code here
	POSITION ps;
	int nIndex;
...
BOOL CSetPort::CheckIdOk(CString strid)
{
	char c;
...
BOOL CSetPort::PreTranslateMessage(MSG* pMsg)
{
